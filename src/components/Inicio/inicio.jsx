  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <Carousel responsive={responsive}>
        <div className="card">
          <h2>Cataratas</h2>
          <img className="product--image" src={cataratas} alt="cataratas" />
        </div>

        <div className="card">
          <h2>Cordoba</h2>
          <img className="product--image" src={cordoba} alt="cordoba" />
        </div>

        <div className="card">
          <h2>Costa</h2>
          <img className="product--image" src={costa} alt="costa" />
        </div>

        <div className="card">
          <h2>Mendoza</h2>
          <img className="product--image" src={mendoza} alt="mendoza" />
        </div>
      </Carousel>
      ...
      <Carousel responsive={responsive}>
        <div className="card">
          <img className="product--image" src={brasil} alt="brasil" />
          <h2>brasil</h2>
        </div>

        <div className="card">
          <img className="product--image" src={caribe} alt="caribe" />
          <h2>caribe</h2>
        </div>

        <div className="card">
          <img className="product--image" src={eeuu} alt="eeuu" />
          <h2>eeuu</h2>
        </div>

        <div className="card">
          <img className="product--image" src={peru} alt="peru" />
          <h2>peru</h2>
        </div>
      </Carousel>
      <div className={styles.buttonContainer}>
